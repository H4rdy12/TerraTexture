...
--dem, or set the TERRATEXTURE_DEMO_TILE environment variable.
...
def main():
    ...
    parser.add_argument(
        "--dem",
        default=os.environ.get("TERRATEXTURE_DEMO_TILE"),
    ...
    if not args.dem:
        raise SystemExit(
            ...
            "the TERRATEXTURE_DEMO_TILE environment variable."
        )
